                ...
                <form method="POST" action="{{route('user.register')}}">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="password2" required type="password" class="form-control" name="password-confirm">
                    </div>
                      <div class="form-group col-6">
                      <label for="password2" required class="d-block">Contact Number</label>
                      <input id="password2" required type="text" class="form-control" name="contact_number">
                    </div>
                      <div class="form-group col-6">
                      <label for="password2" required class="d-block">Designation</label>
                      <input id="password2" required type="text" class="form-control" name="designation">
                    </div>
                     <div class="form-group col-6">
                      <label for="password2" required class="d-block">DOB</label>
                      <input id="date" required type="date" class="form-control" name="dob">
                    </div>
                     <div class="form-group col-6">
                      <label for="password2"  class="d-block">Residence</label>
                      <input id="text" required type="text" class="form-control" name="residence">
                    </div>
                  </div>
                  <div class="row">
                  <div class="form-group col-12">
                      <label for="password2" required class="d-block">Address</label>
                      <input id="password2" required type="text" class="form-control" name="address">
                  </div>
                   <div class="form-group col-12">
                      <label for="password2" required class="d-block">About</label>
                      <textarea required name="about" id="" cols="30" rows="10" class="form-control"></textarea>
                  </div>
                  </div>
