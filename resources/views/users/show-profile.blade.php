    ...
    <div class="col-lg-4">
        ...
        <div class="card-body p-0">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                <a target="_blank" href="https://twitter.com/{{$userTwitterProfile?->nickname}}" href=""><i class="fab fa-twitter fa-lg" style="color: #3b5998;"></i></a>
                <p class="mb-0"><a target="_blank" >{{$user->name}}</a></p>
            </li>
            </ul>
        </div>
        </div>
